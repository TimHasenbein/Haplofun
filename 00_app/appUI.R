...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("Contact & help", tabName = "help", icon = icon("info-circle"))
    ),
    hr(),
    ####---------------------------------------------------------------------####
    ...
    tabItems(
      tabItem(tabName = "home",
              ...
              div(class = "jumbotron-welcome",
                  ...
                  tags$b(h4("Generate, Visualize, and Annotate Genetic Haplotype Networks.", 
              ...
              fluidRow(
                column(6,
                       ...
                       box(
                         title = span(icon("info-circle"), "Data protection declaration", style = "font-weight: bold;"), 
                         ...
                         radioButtons("data_choice", label = NULL,
                                      choices = c("Public or non-human data (no login required)",
                                                  "Private, sensitive human data (login/registration required)")),
                         div(class = "well", style = "background-color: #e6f7ff; border-left: 5px solid #00aaff; padding: 15px;",
                             h4(icon("shield-alt"), "Important disclaimer & responsibility"), 
                             ...
                             tags$ul(style = "padding-left: 20px;", 
                                     ...
                                     tags$li(
                                       "Access to processing sensitive human data is only permitted after registration and login."
                                     )
                             )
                         ),
              ...
              tags$footer(
                ...
                p(
                  ...
                  " | ",
                  actionLink(inputId = "goToHelpTab", label = " Contact and Help"),
                  " | ",
        ...
        fluidRow(
                   ...
                   fluidRow(
                     column(8,
                            ...
                            wellPanel(
                              ...
                              p(strong("Filter VCF file:")),
                              p("If your VCF file is > 500 Kb, please filter by genomic region or MAF:"),
                              p(code("bcftools view -r <region> -Oz -o <subset> <input>")),
                              p(code("bcftools view -e 'MAF < <value>' -Oz -o <subset> <input>"))
                     ...
                     column(4,
                            h4("Test files:"),
                            p(strong("Human data:")),
                            checkboxInput(inputId = "vcfStored_1",label = HTML('1000G data (IL23R locus, hg38)  <a href="https://www.sciencedirect.com/science/article/pii/S2352396425000350?via%3Dihub" target="_blank" style="margin-left: 5px;" title="Zur Quelle"> <i class="fa fa-external-link-alt"></i>  </a>'),value = FALSE),
                            bsTooltip("vcfStored_human","Use 1000G data of the IL23R locus (hg38)"),
                            p(strong("Bacterial data:")),
                            checkboxInput(inputId = "vcfStored_3",label = HTML('H. influenzae (ftsl locus)  <a href="https://link.springer.com/article/10.1186/s13073-024-01406-4" target="_blank" style="margin-left: 5px;" title="Zur Quelle"> <i class="fa fa-external-link-alt"></i>  </a>'),value = FALSE),
                            bsTooltip("vcfStored_3","ftsl locus (Haemophilus influenzae)"),
                            hr(),
                            actionButton(
                              inputId = "run",
          ...
          column(6,  
                 box(
                   ...
                   fluidRow(
                     column(8,
                            fileInput(inputId = "fileSubInfo", label = h5("Upload sample information (.tsv)"), accept = ".tsv", buttonLabel = "Browse"),
                     ...
                     column(4,
                            ...
                            bsTooltip("meta1000G",'Use meta-data sample information for the 1000G data (IL23R data, geographic region) <a href="https://www.internationalgenome.org/" target="_blank" style="margin-left: 5px;" title="Zur Quelle"> <i class="fa fa-external-link-alt"></i>  </a>'),
                            checkboxInput(inputId = "metahinf",label = HTML('H. influenzae (AMR resistance) <a href="https://link.springer.com/article/10.1186/s13073-024-01406-4" target="_blank" style="margin-left: 5px;" title="Zur Quelle"> <i class="fa fa-external-link-alt"></i>  </a>'),value = FALSE),
                            bsTooltip("metahinf","Use sample information for the H. influenzae data about antimicrobial resistance"),
                            p(strong("Human data:")),
                            ...
                            bsTooltip("annoStored1","Use pre-stored ENCODE candidate cis-regulatory elements data (chr1-8, hg38)"),
                            ...
                            bsTooltip("annoStored2","Use pre-stored ENCODE candidate cis-regulatory elements data (chr9-23, hg38)"),
                            p(strong("Bacterial data:")),
                            checkboxInput(inputId = "hinfGwasStored",label = HTML('H. influenzae GWAS (AMR)  <a href="https://link.springer.com/article/10.1186/s13073-024-01406-4" target="_blank" style="margin-left: 5px;" title="Zur Quelle"> <i class="fa fa-external-link-alt"></i>  </a>'),value = FALSE),
        ...
        fluidRow(
          ...
          column(9, 
                 box(
                   ...
                   status = "primary",
                   solidHeader = FALSE,
                   igvShinyOutput("igv_viewer", height="40vh"),
                 ) 
          ) 
        ),
      ...
      tabItem(
        ...
        tags$footer(
          tags$style(HTML("
          .app-footer {
            font-size: 0.85em; /* Slightly smaller for professional look */
            color: #888; 
            text-align: center;
            padding-top: 10px; 
            padding-bottom: 5px;
        ...
        tabBox(
          ...
          tabPanel(
              ...
              column(4,
                     ...
                     p(
                       ...
                       tags$ul(style = "margin-top: 5px;", 
                               tags$li(tags$strong(" Public/non-human data:"), " No login required."),
                               tags$li(tags$strong(" Private/sensitive human data:"), " Registration and login required.")
                       ),
              ...
              column(8,
                     tags$div(
                       tags$video(
                         id = "video_1",
                         type = "video/mp4",
                         src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_1.mov", 
                         controls = "controls",
            ...
            fluidRow(
              column(4,
                     p(
                       ...
                       ", independent of species. The file must be accompanied by a Tabix index file. Furthermore, meta-data files are accepted for optional functional annotation."
                     ),
                     ...
                     div(class = "well", style = "background-color: #f7f7f7; border-left: 5px solid #007bff; padding: 15px;",
                         tags$ul(
                           ...
                           tags$li(tags$strong("GWAS information (.csv):"), 'A Genome-Wide Association Study (GWAS) file for mapping trait-associated single nucleotide polymorphisms (SNPs) to haplogroups. Required columns are comma separated and adhere to the BED-format: "chromosome", "start", "end", "name", "score", "strand", followed by columns for "trait", "risk allele", "pval", and "effect_size".'),
                           tags$li(tags$strong("QTL information (.csv):"), 'A Quantitative Trait Loci (QTL) file for mapping QTLs to haplogroups. Required columns are comma separated and adhere to the BED-format: "chromosome", "start", "end", "name (here REF/Effect allele)", "score", "strand", followed by columns for "tissue", "pip", "effect size (allelic fold change)", and "target gene"'),
                           tags$li(tags$strong("Annotation information (.csv):"), 'A BED6 annotation file for mapping genomic features to haplogroups. Required columns are comma separated and include: "chromosome", "start", "end", "name", "score","strand')
                         )
                     )
              ),
              column(8,
                     tags$div(
                       tags$video(
                         id = "video_2",
                         type = "video/mp4",
                         src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_2.mov", 
                         controls = "controls",
                         style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;"),
                     )
              )
            ...
            fluidRow(
              column(6, 
                     ...
                     tags$ul(style = "margin-top: 5px;", 
                             tags$li(tags$strong("1000G data (IL23R locus, hg38):"), "1000 Genomes project data, filtered for variants of the IL23R gene locus (chr1:66952344-67374700)."),
                             tags$li(tags$strong("H. influenzae (ftsl locus):"), "Example VCF data for the bacterial ftsI gene locus (1688312-1690102).")
                     ),
              ...
              column(6,
                     ...
                     tags$ul(style = "margin-top: 5px;", 
                             ...
                             tags$li(tags$strong("cCREs Annotation (ENCODE):"), "Candidate cis-regulatory elements annotation file from the UCSC genome browser (ENCODE)."),
                             tags$li(tags$strong("H. influenzae (ftsl locus) :"), "GWAS data from H. influenzae GWAS for antimicrobial resistance (Diricks, M., Petersen, S., Bartels, L. et al., Genome Med 2024)."),
                     )
              )
            ),
            hr(style = "border-top: 1px solid #eee; margin: 30px 0;"),
              ...
              column(8,
                     tags$div(
                       tags$video(
                         id = "video_3",
                         type = "video/mp4",
                         src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_3.mov", 
                         controls = "controls",
                         style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;"),
                     )
              )
          ...
          tabPanel(
              ...
              column(8,
                     tags$div(
                       tags$video(
                         id = "video_4",
                         type = "video/mp4",
                         src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_4.mov", 
                         controls = "controls",
                         style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;"),
                     )
              )
            ...
            fluidRow(
              column(4,
                     tags$ul(
                       tags$li(tags$strong("Linkage Disequillibrium (LD) pruning: "), "Filtering option for subsetting the data based on LD pruning. LD is calculated for the variants of your data set. Multiallelic variants are not taken into account and have an LD of 0. For variants that are in LD above the r2 threshold, the first variant per pair is retained when LD pruning is applied."),
              ...
              column(8,
                     tags$div(
                       tags$video(
                         id = "video_11",
                         type = "video/mp4",
                         src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_11.mov", 
                         controls = "controls",
                         style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;"),
                     )
              )
            ...
            fluidRow(
              column(4,
                     ...
                     tags$ul(
                       tags$li(tags$strong("a. Frequencies (Bar Plot): "), "Bar plot showing the frequencies of samples per haplogroup."),
                       tags$li(tags$strong("b. Distance Matrix (Heatmap): "), "The plot shows the distance matrix, calculated by the Hamming distance for the selected number of haplogroups. Furthermore, you can specify if clustering of the matrix should be performed and if so you can select one of the following clustering methods: ",tags$em("ward.D, single, complete, average, mcquitty, median, centroid.")),
                       
                       tags$li(tags$strong("c. Network: "), "This tab shows the network plot for the selected number of haplogroups. Four different network model methods can be selected: ",tags$em("Haplonet, Minimum Spanning Network (MSN), Randomized Minimum Spanning Tree (RMST), and Minimum Spanning Tree (MST)"),". In addition, fast plotting options can be selected for larger data sets.",
                               tags$ul(style="margin-top: 5px;",
                       ...
                       tags$li(tags$strong("d. PCA (Principal Component Analysis): "),"Shown is a Principal component analysis plot showing the PC 1 and 2 for the selected number of haplogroups. The size of the individual dots is scaled to the frequency of samples in that particular haplogroup."),
                       tags$li(tags$strong("e. Dendrogram (Hierarchical Clustering): "),"Dendrogram showing the hierarchical clustering of the selected haplotypes. Different agglomeration methods are available including: ",tags$em("ward.D, single, complete, average, mcquitty, median, centroid.")),
                       tags$li(tags$strong("f. Allele Heatmap (Visual Alignment): "),"Showing the respective alleles per haplogroup, depicted by the different colors.")
                     ),
                       ...
                       tabPanel(
                         ...
                         tags$div(
                           tags$video(
                             id = "video_5",
                             type = "video/mp4",
                             src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_5.mov", 
                             controls = "controls",
                             style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;")
                         )
                       ),
                       tabPanel(
                         ...
                         tags$div(
                           tags$video(
                             id = "video_6",
                             type = "video/mp4",
                             src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_6.mov", 
                             controls = "controls",
                             style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;")
                         )
                       ),
                       tabPanel(
                         ...
                         tags$div(
                           tags$video(
                             id = "video_7",
                             type = "video/mp4",
                             src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_7.mov", 
                             controls = "controls",
                             style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;")
                         )
                       ),
                       tabPanel(
                         ...
                         tags$div(
                           tags$video(
                             id = "video_8",
                             type = "video/mp4",
                             src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_8.mov", 
                             controls = "controls",
                             style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;")
                         )
                       ),
                       tabPanel(
                         ...
                         tags$div(
                           tags$video(
                             id = "video_9",
                             type = "video/mp4",
                             src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_9.mov", 
                             controls = "controls",
                             style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;")
                         )
                       ),
                       tabPanel(
                         ...
                         tags$div(
                           tags$video(
                             id = "video_10",
                             type = "video/mp4",
                             src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_10.mov", 
                             controls = "controls",
                             style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;")
                         )
                       )
          ...
          tabPanel(
            ...
            p("The meta-data annotation can be used to enrich the visual analysis of your results. This function allows you to colorize the haplotype frequency bar plots and the evolutionary network plots according to sample traits, such as geographic location or phenotype. For this feature the structure of the meta-data file must adhere to the format described in Section 1.2 Data upload."),
            tags$div(
              tags$img(src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/meta_2.png", 
                       alt = "Overview of Haplotype Analysis interface showing filtering, table, and network views.", 
                       style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;"),
              tags$small(em("Figure 1: Meta-data coloring. The frequency bar plot and haplotype network can be colored according to meta-data information."),
              ...
              column(8,
                     tags$div(
                       tags$video(
                         id = "video_12",
                         type = "video/mp4",
                         src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_12.mov", 
                         controls = "controls",
                         style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;")
                     )
              )
            ...
            fluidRow(
              column(4,
                     ...
                     tags$ul(
                       ...
                       tags$li(tags$strong("QTL allele mapping: "), "The heatmap shows the presence of QTL alleles across the haplogroups. Color-coded cells depict whether a effect allele is present in a particular haplogroup. The color itself denotes the associated target gene per allele."),
              ...
              column(8,
                     tags$div(
                       tags$video(
                         id = "video_13",
                         type = "video/mp4",
                         src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_13.mov", 
                         controls = "controls",
                         style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;")
                     )
              )
            ...
            fluidRow(
              column(4,
                     ...
                     tags$ul(
                       ...
                       tags$li(tags$strong("Annotation mapping: "), "The heatmap shows the allele of a variant that overlaps a genomic feature. The color denotes the bases."),
              ...
              column(8,
                     tags$div(
                       tags$video(
                         id = "video_14",
                         type = "video/mp4",
                         src = "https://raw.githubusercontent.com/TimHasenbein/PegasShiny/main/data/video_14.mov", 
                         controls = "controls",
                         style = "width: 100%; max-width: 1500px; display: block; margin: 20px auto; border: 1px solid #ccc;")
                     )
              )
