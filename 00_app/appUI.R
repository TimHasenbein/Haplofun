              ...
              fluidRow(
                column(6,
                       ...
                       box(
                         ...
                         status = "primary",
                         tags$ul(
                           tags$li(HTML("<strong>VCF compatibility:</strong> Designed to process monoploid or phased diploid VCF (variant call format) files.")),
                   ...
                   fluidRow(
                     column(8,
                            ...
                            wellPanel(
                              ...
                              p(
                                strong("Note: "), 
                                "The web server is designed for ",
                                code("monoploid"),
                                " or ",
                                code("phased diploid"),
                                " VCF files with up to ", 
    ...
    "))
        ...
        tabBox(
          ...
          tabPanel(
            ...
            fluidRow(
              column(4,
                     ...
                     div(class = "well", style = "background-color: #f7f7f7; border-left: 5px solid #007bff; padding: 15px;",
                         tags$ul(
                           tags$li(tags$strong("VCF file (vcf or vcf.gz):"), "The main data file. Must include monoploid or  ", tags$strong("phased"), " diploid sample genotype information (GT field). To perform genotype phasing you can use ", tags$a(href = "https://www.nature.com/articles/ng.3679", target = "_blank", "Eagle2"), " or ", tags$a(href = "https://www.nature.com/articles/s41588-023-01415-w", target = "_blank", "SHAPEIT5"), ". The file size limit is ", tags$strong("500 kb"), " for the public server, including a recommended size of ", tags$strong("< 1,000 variant and < 1,000 samples"),". For large files, pre-filtering with bcftools or the local version is required. Multiallelic variants must be represented as comma-separated values within a single line rather than split across multiple bi-allelic records. Missing genotypes are treated as missing values and handled according to the respective conventions of the vcfR and pegas packages; users are referred to the vcfR and pegas documentation for further detail."),
                         )
                     ),
                     ...
                     div(class = "well", style = "background-color: #f7f7f7; border-left: 5px solid #007bff; padding: 15px;",
                         tags$ul(
                           ...
                           tags$li(tags$strong("GWAS information (.csv):"), 'A Genome-Wide Association Study (GWAS) file for mapping trait-associated single nucleotide polymorphisms (SNPs) to haplogroups. Required columns are comma separated and adhere to the format: "chromosome", "start", "end", "name", "score", "strand", "trait", "risk allele", "pval", and "effect_size". "Start" and "end" must equal the position of your VCF`s POS column.'),
                           tags$li(tags$strong("QTL information (.csv):"), 'A Quantitative Trait Loci (QTL) file for mapping QTLs to haplogroups. Required columns are comma separated and adhere to the format: "chromosome", "start", "end", "name (here REF/Effect allele)", "score", "strand", "tissue", "pip", "effect size (allelic fold change)", and "target gene". "Start" and "end" must equal the position of your VCF`s POS column.'),
            ...
            fluidRow(
              column(6, 
                     ...
                     tags$ul(style = "margin-top: 5px;", 
                             tags$li(tags$strong("1000G data (", tags$em("IL23R"), " locus, hg38):"), "1000 Genomes project data, filtered for selected variants of the ", tags$em("IL23R"), " gene locus (chr1:66952344-67374700)."),
            ...
            fluidRow(
              column(4,
                     ...
                     tags$ul(
                       ...
                       tags$li(tags$strong("Integrative genomics viewer: "), "IGV browser for visualization. The reference annotation can be selected in the ",tags$strong("Select genome build for IGV "), "tab."),
          ...
          tabPanel(
            ...
            p("This section facilitates the primary analysis of haplotypes, providing both quantitative data and comprehensive visualization. The interface is organized into three distinct, interactive components: ",tags$strong("Data filtering "), ", ",tags$strong("Genotype data table "), ", ",tags$strong("Haplotype visualizations "), "and ",tags$strong("Advanced filtering options.")),
            ...
            fluidRow(
              column(4,
                     tags$ul(
                       tags$li(tags$strong("Linkage disequillibrium (LD) pruning: "), "Filtering option for subsetting the data based on LD pruning. LD is calculated for the variants of your data set. Multiallelic variants cannot be processed reliably due to limitations of the pegas package. For variants that are in LD above the r2 threshold, the first variant per pair is retained when LD pruning is applied. Note: LD cannot be calculated for monomorphic variants, which will be removed for the analysis."),
                     ...
                     tags$ul(
                       ...
                       tags$li(tags$strong("Network: "), "This tab shows the network plot for the selected number of haplogroups and is computed using the pegas package. Four different network model methods can be selected: ",tags$em("Haplonet, Minimum Spanning Network (MSN), Randomized Minimum Spanning Tree (RMST), and Minimum Spanning Tree (MST)"),". In addition, fast plotting options can be selected for larger data sets.",
                               tags$ul(style="margin-top: 5px;",
                                       ...
                                       tags$li(tags$strong("Network statistics table: "), "The table additionally shows the ", tags$em("Total Number of calculated Links"), ", ", tags$em("Number of Links currently shown"), ", ", tags$em("Haplotype Diversity"), " (measurement of genetic diversity in a population), ", tags$em("Branch Diversity"), " (measurement of topological diversity in the haplotype network), and ", tags$em("Haplotype Network Branch Diversity"), " (combines Hd and Bd). For more information, click ", tags$a(href = "https://pmc.ncbi.nlm.nih.gov/articles/PMC8244886/", target = "_blank", "here"), ".")
                               )
                       ),
