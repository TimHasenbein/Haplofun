...
server <- function(input, output, session) {
  ...
  observe({
    req(filteredVcfData())
    req(getHaplotypes())
    # calculateHaplonet() can fail (e.g. the 20s timeout on a large/degenerate network)
  ...
  category_colors <- reactive({
    ...
    cols <- c("#246ca7ff","#fcb9cfff","#7bc3f9ff","#319533ff","#840e0eff","#D95F02", "#7570B3", "#E7298A", "#66A61E", "#E6AB02", 
