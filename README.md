...
| **PCA** | Principal component analysis (PC1 vs. PC2) for the selected haplogroups; dot size scaled to haplogroup sample frequency. The table shows the `Total Number of calculated Links`, `Number of Links currently shown`, `Haplotype Diversity (measurement of genetic diversity in a population)`, `Branch Diversity (measurement of topological diversity in haplotype network)`, and ` Haplotype Network Branch Diversity (combines Hd and Bd)`. For more information clicke [here](https://pmc.ncbi.nlm.nih.gov/articles/PMC8244886/)     |
