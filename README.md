...
- **Random SNP sub-sampling**: Randomly selects a specified number of variants from the current filtered dataset, used to assess the robustness and variability of the inferred haplogroup network. Comparing networks from multiple random SNP subsets shows how stable the genetic relationships are for the predefined variant set.
